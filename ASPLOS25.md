...
We used this smaller subset for the
  _submitted_ version of this paper;
  the longer evaluation was done under guidance
  from our shepherd.
...
| Raspbian Bookworm | ARM Cortex-A72 | 4 | ![Figure 7](infra/figures/config-4/c-pareto.png) |
...
| Raspbian Bookworm | ARM Cortex-A72 | 4 | ![Figure 8](infra/figures/config-4/baseline-pareto.png) |
...
| Raspbian Bookworm | ARM Cortex-A72 | 4 | ![Figure 9](infra/figures/config-4/baseline-pareto2.png) |
